      ...
      <div className="grid md:grid-cols-2 gap-8">
        <div className="bg-white p-10 rounded-2xl shadow-sm hover:shadow-md transition-shadow text-left space-y-6 border border-gray-100">
          ...
          <div className="grid grid-cols-2 gap-3 text-sm font-medium">
            ...
            <div className="flex items-center gap-2 text-gray-700">✓ 퇴근 후 / 주말 활용 가능</div>
            <div className="flex items-center gap-2 text-gray-700">✓ 짧은 시간 투자</div>
          </div>
        </div>
        <div className="bg-white p-10 rounded-2xl shadow-sm hover:shadow-md transition-shadow text-left space-y-6 border border-gray-100">
          <div className="text-4xl">💼</div>
          ...
          <div className="grid grid-cols-2 gap-3 text-sm font-medium">
            ...
            <div className="flex items-center gap-2 text-gray-700">✓ 출근 없이 재택근무 가능</div>
            <div className="flex items-center gap-2 text-gray-700">✓ 교육·시스템 지원</div>
            <div className="flex items-center gap-2 text-gray-700">✓ 소득+연2회 해외연수 기회</div>
          </div>
        </div>
      </div>
      <p className="text-xl font-medium text-gray-700">
        "시간은 그대로 두고 수입만 추가하세요.<br />
        부담 없이 상담부터 받아보셔도 좋습니다.<br />
        간단한 등록으로 국내 33개 보험사의 상품들을 만나보세요."
      </p>
    </div>
  </section>
);
