...
const Hero: React.FC = () => {
  return (
    <section className="relative h-screen min-h-[700px] flex items-center overflow-hidden bg-white">
      {/* Background Image - The original high-end professional model from the first build */}
      ...
      <div className="container mx-auto px-4 relative z-10">
        <div className="max-w-xl">
          ...
          <h1 className="text-5xl md:text-7xl font-extrabold leading-[1.1] mb-8 tracking-tight text-gray-900">
